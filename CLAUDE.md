...
| `CilCpu.Sim.Tests` | xUnit tesztek (187), minden projekthez |
...
- **TExecutor** (`src/CilCpu.Sim/TExecutor.cs`) — 64 opkód végrehajtási logika
...
64 opkód, int32-only, objektumok nélkül. Részletes spec: `docs/ISA-CIL-T0.md`
