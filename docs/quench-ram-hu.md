...
A Quench-RAM biztonsága **nem privilégium-szeparációra** épül (nincs kernel mode vs. user mode — a Neuron OS explicit elveti ezt, lásd `docs/neuron-os-hu.md` 731. sor). Helyette **két meglévő mechanizmus kombinációjára**:
...
A `docs/neuron-os-hu.md` 366–369. sora rögzíti, hogy minden Rich core saját **bump allocator + mark-sweep GC**-vel rendelkezik. A Quench-RAM ezt a GC-t **drámaian leegyszerűsíti**:
...
A `docs/neuron-os-hu.md` 388–398. sorában definiált `ActorRef` egy capability-token. A Quench-RAM ezt **fizikailag védhetővé teszi**:
...
- `docs/neuron-os-hu.md` — a per-core GC és capability registry, amelyek a Quench-RAM-ot használják
