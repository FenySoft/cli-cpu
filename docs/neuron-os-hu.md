...
> *A Neuron OS a **CFPU** hardveres platformra készül — a CFPU referencia implementációja a **CLI-CPU** projekt. Részletek: [FAQ #1](faq-hu.md#1-mi-a-cfpu-és-mi-a-kapcsolata-a-cli-cpu-val).*
