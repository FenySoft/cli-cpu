...
- **Denial of Service** — egy rosszindulatú core telesprayelheti a mailboxokat, ami a rendszert lelassítja. A rate limiting a szoftveres runtime (Symphact) feladata.
...
| Stateful signature key reuse | — | Könnyű szoftveres signer-nél | **Kizárva** ([Symphact HSM Card](authcode-hu.md#neuroncard): single-use NVRAM) |
...
### Firmware / Symphact réteg (a projekt felelőssége)
