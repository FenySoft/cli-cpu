...
**Cél:** Az első **heterogén Cognitive Fabric szilícium** — **1 Rich + 8 Nano core, 48 KB on-chip SRAM, 3 mm² IHP SG13G2**. Ez a lépcsőfok az F3 egymagos Tiny Tapeout és a teljes „Cognitive Fabric One" (10 mm²) között. **Potenciálisan €0 költséggel** elérhető az IHP FMD-QNC ingyenes kutatási MPW programján.
...
- A **Cognitive Fabric One** (ChipIgnite, 6R+17N+1S) a teljes skálán bizonyít — benchmarkokkal, publikációval
...
**Cél:** A **„Cognitive Fabric One"** — az F6-FPGA-ban (A7-Lite 200T multi-board hálón) verifikált és sweet spot-ra optimalizált heterogén design **valós szilíciumon**: **6 Rich + 17 Nano + 1 Secure core, 152 KB on-chip SRAM, 10 mm² Sky130**. Ez a chip bizonyítja, hogy ugyanazon a szilíciumon a Cognitive Fabric paradigma **5–23× több hasznos munkát végez** actor-alapú workload-okon, mint egy hagyományos multi-core CPU — miközben determinisztikus, hardveresen izolált, és lineárisan skálázódik. Részletes chip-vízió és benchmark-összehasonlítás: [`docs/architecture-hu.md`](architecture-hu.md) „Cognitive Fabric One" szekció. **Előfeltétel: az F6-FPGA minden kész kritériuma teljesül** — nem indulhat silicon tape-out FPGA-verifikáció nélkül.
...
- **Publikációs anyag** — benchmark riport, a „Cognitive Fabric One" narratíva: *„ugyanazon a szilíciumon 5–23× több hasznos munka actor-alapú workload-okon"*

**Függőség:** **F6-FPGA kész** (minden kész kritérium teljesül), sweet spot kiválasztva, multi-konfiguráció riport elérhető.

**Költség-nagyságrend:** ~$14,950 (eFabless ChipIgnite, 10 mm², 100 QFN chip + eval board), vagy ~€4,500 (IHP SG13G2 3 mm², kisebb konfiguráció: 1R+8N), vagy **€0** (IHP ingyenes kutatási MPW / Google Open MPW, ha elérhető). **NLnet NGI Zero Commons Fund** pályázattal akár a teljes F6-Silicon fedezhető (€5K–€50K).
...
| **C: NLnet €30K** | ~€30K | B szcenárió + ChipIgnite „Cognitive Fabric One" (6R+17N+1S, 10 mm²) |
